...
<section class="products">
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
      ...
      <div class="price"><?php echo $fetch_products['price']; ?>k đ/-</div>
...
<section class="home-contact">
   ...
   <div class="content">
      ...
      <p>Tất cả những gì con người làm, nghĩ hoặc trở thành được bảo tồn một cách kỳ diệu trên những trang sách.</p>
      <a href="contact.php" class="white-btn">Liện hệ chúng tôi</a>
   </div>
