...
<div class="heading">
   ...
   <p> <a href="home.php">home</a> / giỏ hàng </p>
</div>
...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="price"><?php echo $fetch_cart['price']; ?>k đ/-</div>
         <form action="" method="post">
            <input type="hidden" name="cart_id" value="<?php echo $fetch_cart['id']; ?>">
            <input type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart['quantity']; ?>">
            <input type="submit" name="update_cart" value="cập nhật" class="option-btn">
         </form>
         <div class="sub-total"> Tổng : <span><?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?>k đ/-</span> </div>
      </div>
      <?php
   ...
   <div class="cart-total">
      <p>Tổng cộng : <span><?php echo $grand_total; ?>k đ/-</span></p>
      <div class="flex">
         <a href="shop.php" class="option-btn">tiếp tục mua sắm</a>
         <a href="checkout.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">tiến hành kiểm tra</a>
      </div>
   </div>
